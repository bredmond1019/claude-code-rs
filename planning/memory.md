---
type: Reference
title: claude-code-rs Memory
description: Repo-scoped durable memory for claude-code-rs — episodic notes, preferences, superseded facts. Committed and portable.
doc_id: memory
layer: [factory]
status: active
