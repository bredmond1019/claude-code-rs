---
type: Reference
title: claude-code-rs Knowledge
description: Distilled, durable knowledge for claude-code-rs — how it works, conventions, and an architecture digest.
doc_id: knowledge
layer: [factory]
status: active
